...
$features = array(
    ...
    'image' => $this->get_asset('feature-one.png'),
  ...
  array(
    ...
    'image' => $this->get_asset('feature-two.png'),
  ...
  array(
    ...
    'image' => $this->get_asset('feature-three.png'),
 ...
 */
$actionButton = array(
  'title' => __('Now that you know everything you can do using this plugin, click below to start! And please don\'t forgot to rate the plugin, if you like it.', $this->textDomain),
