 ...
 */
$primary_color  = WU_Util::color($atts['primary_color']);
$accent_color   = WU_Util::color($atts['accent_color']);
$accent_color_2 = WU_Util::color($accent_color->darken(4));
...
if (!isset($is_shortcode) || !$is_shortcode || $atts['show_selector']) {
  ...
  wu_get_template('signup/pricing-table/frequency-selector');
...
if (empty($plans)) {
  ...
  wu_get_template('signup/pricing-table/no-plans');
  ...
  <form id="signupform" method="post">
    ...
    <div class="layer plans">
      ...
      foreach($plans as $plan) {
        ...
        wu_get_template('signup/pricing-table/plan', array(
          'plan'         => $plan,
          'count'        => $count,
          'columns'      => $columns,
...
<script type="text/javascript">
  ...
  (function ($) {
    $(document).ready(function () {
       ...
       */
      setTimeout(function() {
        $('[data-frequency-selector="<?php echo WU_Settings::get_setting('default_pricing_option', 1);?>"]').click();
      }, 100);
