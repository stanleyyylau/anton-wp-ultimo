...
class WU_Page {
  ...
  public function add_menu_page() {
    ...
    /**
     * Add the page to WP Ultimo's branding (aka. topbar)
     */
    if ($this->network) {

      WU_UI_Elements()->add_page_to_branding($this->page_hook);
   ...
   * @return void
   */
  public function page_loaded() {} // end init;
