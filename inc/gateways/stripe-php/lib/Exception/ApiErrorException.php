...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param array|\WU_Stripe\Util\CaseInsensitiveArray|null $httpHeaders The HTTP headers array.
     ...
     *
     * @return \WU_Stripe\ErrorObject|null
     */
     ...
     *
     * @param \WU_Stripe\ErrorObject|null $error
     */
     ...
     *
     * @return array|\WU_Stripe\Util\CaseInsensitiveArray|null
     */
     ...
     *
     * @param array|\WU_Stripe\Util\CaseInsensitiveArray|null $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \WU_Stripe\ErrorObject} for possible
     * values.
     *
     * @return string|null
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \WU_Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
